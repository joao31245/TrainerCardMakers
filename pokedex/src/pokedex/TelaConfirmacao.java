...
public class TelaConfirmacao extends javax.swing.JFrame {
    ...
    private TelaTrainerCard telaTrainerCard;
    public TelaConfirmacao() {
        initComponents();
        this.telaTrainerCard = new TelaTrainerCard();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pokedex/pok.png"))); // NOI18N

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pokedex/ven.png"))); // NOI18N
        jLabel5.setText("jLabel5");

        btnConfirmar.setBackground(new java.awt.Color(191, 4, 4));
        btnConfirmar.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnConfirmar.setForeground(new java.awt.Color(166, 144, 36));
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        try {
            ...
            Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/pokedex", "root", "duda#123A");
            Statement statement = connection.createStatement();
            
            String select = "select * from treinadores";
            ResultSet checkSelect = statement.executeQuery(select);
            boolean achou = false;
            while(checkSelect.next()) {
                String userId = checkSelect.getString("id_treinador");
            ...
            if(achou) {
                this.setiDTrainer(userID);
                JOptionPane.showMessageDialog(this, "Usuário encontrado.");
                dispose();
                this.telaTrainerCard.setVisible(achou);
                this.telaTrainerCard.setiDTrainer(iDTrainer);
            } else {
