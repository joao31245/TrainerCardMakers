...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {tfIDTreinador, tfSenhaTreinador});
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      // TODO add your handling code here:
      // Puxando os dados digitados nos campos de texto.
        String userID = tfIDTreinador.getText();
        String userPawssword = tfSenhaTreinador.getText();
        ...
        try {  
           ...
           ResultSet resultSet = connection.getStatement().executeQuery(sql);
            ...
            // Condição booleana para conferir login.
            boolean achou = false;
            
            /*Looping de repetição que vai comparar os nomes do banco de dados
            com os nomes digitados e alterar a condição boleana caso econtre.*/
            while(resultSet.next()) {
                String userIDDB = resultSet.getString("id_treinador");
                String userPasswordDB = resultSet.getString("senha");
                
                if(userID.equals(userIDDB) && userPawssword.equals(userPasswordDB)) {
                    achou = true;
                    break;
                }           
            }
            
            // Caso encontre vai pegar o valor e armazenar no objeto da classe.
            if(achou) {
                this.iDTrainer = String.valueOf(userID);
                dispose();
            }
            
            // Caso não encontre mostre mensagem de erro.
            else {
